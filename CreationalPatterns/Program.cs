...
namespace CreationalPatterns
{
    class Program
    {
        ...
        static void FactoryMethodTest(){
            ...
            PlayerManager testPlayerManager = new PlayerManager();
        ...
        {
            Map map = new Map(new List<TerainType>() { TerainType.Earth, TerainType.Mount, TerainType.Earth, TerainType.Water, TerainType.Earth});
        ...
        static void AbstractFactoryTest()
        {
            ...
            Loger.GetLoger().Write(string.Format("Юнит нанес {0} Урона", player.GetArcher(10, 3).Shoot(20)));
